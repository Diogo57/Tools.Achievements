...
namespace Tools.Achievements
{
    ...
    {
        public AchievementData(AchievementTemplateRecord record, Achievement d2o, List<ObjectiveData> data, List<RewardData> rewards)
        {
            Template = record;
            AchievementD2O = d2o;
            ObjectivesData = data;
        ...
        public AchievementTemplateRecord Template
        {
            get;
            set;
        }
    ...
    {
        public RewardData(AchievementRewardRecord record, AchievementReward d2o)
        {
            Template = record;
            RewardD2O = d2o;
        }

        public AchievementRewardRecord Template
        {
            get;
            set;
        }
        ...
        public List<uint> ItemsQuantities
        {
            ...
            set
            {
                ...
                Template.ItemsQuantityReward = value.ToArray();
            }
        }
        public List<uint> ItemsReward
        {
            ...
            set
            {
                ...
                Template.ItemsReward = value.ToArray();
            }
        }
    ...
    {
        public ObjectiveData(AchievementObjectiveRecord record, AchievementObjective d2o)
        {
            Template = record;
            ObjectiveD2O = d2o;
        }

        public AchievementObjectiveRecord Template
        {
            get;
            set;
        }
    ...
    {
        public CategoryData(AchievementCategoryRecord template, AchievementCategory d2o)
        {
            Template = template;
            CategoryD2O = d2o;
        }
        public AchievementCategoryRecord Template
        {
            get;
            set;
        }
